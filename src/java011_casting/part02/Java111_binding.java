...
public class Java111_binding {
	...
	public static void main(String[] args) {
		Employee employee = new Employee("Steven","code001"); //1
		process(employee);
		Manager manager = new Manager ("TaeO","code002", "second"); //1
		process(manager);
	}// end main
	
	
	public static void process (Object obj) {//Object(부모 클래스) 
		System.out.println(obj.toString());
		if(obj instanceof Employee) {
			Employee ee= (Employee)obj;// 업캐스팅
...
//	}
//	public static void process(Employee emp1) {
