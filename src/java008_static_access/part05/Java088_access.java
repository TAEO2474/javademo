package java008_static_access.part05; // package는 한번만 사용 가능
 //import java.lang.String; //-> 외부자원을 쓸때는 이러게 작성해서 사용해야한다.
 //inport java.lang.System; //-> import 여러번 사용 가능.
public class Java088_access {

	private int var_private =1; // class Java088_access에서만 사용가능 !
	int var_default = 2;
...
//
//접근제어자 범위
//private < default (때때로, package 표현) < protected < public   
