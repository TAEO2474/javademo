...
//인터페이스(interface) - 모두가 추상 클래스이다
//1. 추상메소드와 상수를 가지고 있는 형태이다. (상수는 멤버변수에서 딱 한번만 값이 고정된다. 예시 int age = 17;)
...
public class Java106_interface {
	...
	public static void main(String[] args) {
		...
		// interface에서 Static 선언된 메소드는 객체참조변수.method()호출할 수 없다. static void display()
		// Truck.display();
		truck.prn();
		truck.call();
