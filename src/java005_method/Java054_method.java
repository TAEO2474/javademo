...
//
//method 정의 : 선언부 + 구현부
//반환자료형 메소드명(데이터타입 매개변수: 파라미터)      => 메소드 선언부
//{
...
//  int y = 20;
// 
//   return (x+y)/2.0;     ->위에서 저장한대로 double로 캐스팅된다
//}
//
//double res = avg();
//
...
//
//    (argument-인수)
//plus(10, 20);     -> 이렇게 위의 값이 X:10, y:20 전달
//
...
public class Java054_method {
	...
	public static void main(String[] args) {   //1
		...
		makeTest(); // 아래 새로 생성한 매소드로 이동 //3 
		System.out.println("main end");        //7
	} // end main                              //8

	public static void makeTest() {           //4
		System.out.println("mekeTest run");   //5
	} //end mekeTest()                       //6
} //end class
