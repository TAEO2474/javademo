...
public class Java070_class {
	...
	public static void main(String[] args) {
		...
		System.out.printf("var_dounle:%.1f\n", mv.var_double);
		
		System.out.printf("var_boolean:%b\n", mv.var_boolean);
		System.out.printf("var_char:%c\n", mv.var_char);
		
		System.out.printf("var_char = %s\n", mv.var_str);
		System.out.printf("var_arr = %d\n", mv.var_arr);

		//지역변수(local variable)은 개발자가 직접 초기화 하지 않고 호출하면 오류가 발생!!
		//erro : The local variable 'num' may not have been initialized!!!
//		int num;
